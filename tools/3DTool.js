    ...
    this.draw = function () {
        if (mouseIsPressed) {
            ...
            if (this.frames > this.lowerBound && this.frames < this.upperBound) {
                ...
                this.sphere =
                    eventConditions.drawSphereCondition != false ? this.graphics.sphere(70) : this.sphere;

                this.cone =
                    eventConditions.drawConeCondition != false ? this.graphics.cone(70, 30) : this.cone;
