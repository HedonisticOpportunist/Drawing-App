/*
GEOMETRIC SHAPES TOOL FUNCTION
*/
    ...
    this.draw = function () {
        if (mouseIsPressed && drawingProperties.sliderValue != null) {
            ...
            if (this.startMouseX == -1) {
                ...
                this.drawRectangle =
                    eventConditions.drawRectangleCondition != false ? this.scribble.scribbleRect(
                        this.startMouseX,
                        this.startMouseY,
                        mouseX,
                        mouseY
                ...
                this.drawEllipse =
                    eventConditions.drawEllipseCondition != false ? this.scribble.scribbleEllipse(
                        this.startMouseX,
                        this.startMouseY,
                        mouseX,
                        mouseY
                ...
                this.drawTriangle =
                    eventConditions.drawTriangleCondition != false ? tri(this.startMouseX, this.startMouseY, 50, 1) : this.drawTriangle;

                this.drawHeart =
                    eventConditions.drawHeartCondition != false ? heart(this.startMouseX, this.startMouseY, 50, 1) : this.drawHeart;

                this.drawLine =
                    eventConditions.drawLineCondition != false ? this.scribble.scribbleLine(
                        this.startMouseX,
                        this.startMouseY,
                        mouseX,
                        mouseY
