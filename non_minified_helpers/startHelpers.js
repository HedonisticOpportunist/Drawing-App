...
function StartHelpers() {
    ...
    */
    this.setupTools = function () {
        ...
        tools = [new FreehandTool(), new LineToTool(), new SprayCanTool(),
        new MirrorDrawTool(), new AddTransparentLayer(),
        new ImageTool(), new GeometricShapesTool(),
        new StampTool(), new EraserTool(),
        new RandomStringsTool(), new ThreeDimensionalTool(),
        new AnimationTool(), new CroppingTool()];
