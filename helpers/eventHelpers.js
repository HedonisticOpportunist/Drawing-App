...
function EventHelpers() {
    ...
    eventConditions.drawRectangleCondition =
        ...
        !this.drawHeart &&
        !this.drawLine;
    eventConditions.drawEllipseCondition = !this.drawRectangle &&
        this.drawEllipse &&
        !this.drawTriangle &&
        !this.drawHeart &&
        !this.drawLine;
    eventConditions.drawTriangleCondition = !this.drawRectangle &&
        !this.drawEllipse &&
        this.drawTriangle &&
        !this.drawHeart &&
        !this.drawLine;
    eventConditions.drawHeartCondition = !this.drawRectangle &&
        !this.drawEllipse &&
        !this.drawTriangle &&
        this.drawHeart &&
        !this.drawLine;
    eventConditions.drawLineCondition = !this.drawRectangle &&
        !this.drawEllipse &&
        !this.drawTriangle &&
        !this.drawHeart &&
        this.drawLine;
        ...
        if (selectorArrays.hasOwnProperty(key)) {
            if (key == "catIDsArray") {
                for (let i = 0; i < selectorArrays.catIDsArray.length; i++) {
                    ...
                    select(selectorArrays.catIDsArray[i].name).mouseClicked(
                        function () {
